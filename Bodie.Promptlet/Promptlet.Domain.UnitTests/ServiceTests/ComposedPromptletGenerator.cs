...
namespace Promptlet.Domain.UnitTests.ServiceTests
{
    public class ComposedPromptletGenerator
    {
        ...
        public static ComposedPromptlet[] GenerateComposedPromptlets(int composedPromptletCount, int promptletArtifactCountPerComposedPromptlet)
        {
            ...
            for (int i = 0; i < composedPromptletCount; i++)
            {
                composedPromptlets[i] = new ComposedPromptlet
                {
                    ...
                    PromptletArtifacts = PromptletArtifactGenerator.GeneratePromptletArtifacts(promptletArtifactCountPerComposedPromptlet)
                };
            }
